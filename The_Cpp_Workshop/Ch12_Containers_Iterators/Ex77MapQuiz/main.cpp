...
int main () {
	...
	Question question1 (1,
					 "Which two actors directed themselves in movies and won Oscars for Best Actor?", 2);
	...
	Question question2 (2,
					 "\"After all, tomorrow is another day!\" was the last line in which Oscar-winning Best Picture?", 0);
